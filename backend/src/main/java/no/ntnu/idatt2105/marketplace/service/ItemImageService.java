...
public class ItemImageService {
  ...
  /**
   * Uploads images for a specific item. This method does not replace existing
   * images,
  ...
  /**
   * Retrieves the IDs of all images associated with a specific item.
   *
   * @param itemId the ID of the item
   * @return a list of image IDs
   */
  public List<Long> getItemImageIds(Long itemId) {
